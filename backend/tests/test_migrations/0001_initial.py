    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "columnid",
                    models.ForeignKey("Column", models.DO_NOTHING, db_column="columnID", blank=True, null=True),
                ),
                ("color", models.TextField(blank=True, null=True)),
                ("title", models.TextField(blank=True, null=True)),
                ("ordernum", models.IntegerField(db_column="orderNum")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "ticketid",
                    models.ForeignKey("Ticket", models.DO_NOTHING, db_column="ticketID", blank=True, null=True),
                ),
                (
                    "swimlanecolumnid",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "actionid",
                    models.ForeignKey("Action", models.DO_NOTHING, db_column="actionID", blank=True, null=True),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "usergroupid",
                    models.ForeignKey("Usergroup", models.DO_NOTHING, db_column="usergroupID", default=uuid.uuid4),
                ),
