...
const TaskCreationForm: React.FC<TaskCreationFormProps> = (props) => {
  ...
  const { onSubmit, onCancel, defaultValues, setDefaultValues } = props
    ...
    <ClickAwayListener mouseEvent="onMouseDown" touchEvent="onTouchStart" onClickAway={onModuleClose}>
      <form onSubmit={handleSubmit(handleFormSubmit)}>
        <Grid container spacing={2}>
          ...
          <Grid item xs={12}>
            <DescriptionEditField description={defaultValues?.description || ""} onChange={(markdown) => setValue("description", markdown)} />
          </Grid>
          <Grid item xs={12}>
            <FormControl component="fieldset">
              ...
              >
                ...
                <FormControlLabel
                  value="#ffeb3b"
                  control={<Radio style={{ color: "#ffeb3b" }} />}
                  checked={selectedColor === "#ffeb3b"}
                  label={undefined}
                />
                <FormControlLabel
                  value="#8bc34a"
                  control={<Radio style={{ color: "#8bc34a" }} />}
                  checked={selectedColor === "#8bc34a"}
                  label={undefined}
                />
                <FormControlLabel
                  value="#ff4081"
                  control={<Radio style={{ color: "#ff4081" }} />}
                  checked={selectedColor === "#ff4081"}
                  label={undefined}
                />
                <FormControlLabel
                  value="#03a9f4"
                  control={<Radio style={{ color: "#03a9f4" }} />}
                  checked={selectedColor === "#03a9f4"}
                  label={undefined}
                />
              </RadioGroup>
            </FormControl>
